/**
 * @file        mswin/utctime.h
 * @copyright   2021 Andrew MacIsaac
 * @remark
 *      SPDX-License-Identifier: BSD-2-Clause
 *
 * @brief       Alpha Caeli UTC time conversion port implementation for Windows platforms.
 ...
 */
#   define AC_CONVERT_UTC_TIME(seconds, ptm) (gmtime_s((ptm), &(seconds)) == 0 ? 0 : -1)
